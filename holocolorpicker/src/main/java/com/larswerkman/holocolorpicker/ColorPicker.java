...
public class ColorPicker extends View {
	...
	private static final String STATE_NEW_COLOR = "newColor";
	 ...
	 * 
	 * <p>
	 * Note: The algorithm in {@link #calculateColor(float)} highly depends on
	...
	protected Parcelable onSaveInstanceState() {
		...
		state.putInt(STATE_NEW_COLOR, mCenterNewColor);
	...
	protected void onRestoreInstanceState(Parcelable state) {
		...
		setNewCenterColor(savedState.getInt(STATE_NEW_COLOR));
