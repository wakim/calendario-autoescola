...
public class SnackBar {
    ...
    private OnDismissConfirmedListener mDismissConfirmedListener;
	...
	public <T> T getCurrentParcelable() {
		if(mCurrentSnack == null) {
			return (T) null;
		}

		return (T) mCurrentSnack.mToken;
	}
    ...
    public interface OnDismissConfirmedListener {
        void onDismissed(Parcelable token);
    }

    public SnackBar(Activity activity, ViewGroup parent) {
        View v = activity.getLayoutInflater().inflate(R.layout.sb__snack, parent);
        init(v);
    }
    ...
    private void init(View v) {
        ...
        mFadeOutAnimation.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationEnd(Animation animation) {
                if(mDismissConfirmedListener != null && mCurrentSnack != null && mCurrentSnack.mActionMessage != null) {
                    mDismissConfirmedListener.onDismissed(mCurrentSnack.mToken);
                }
    ...
    public void destroy() {
        ...
        mClickListener = null;
        mDismissConfirmedListener = null;
    ...
    public OnMessageClickListener getOnClickListener() {
        return mClickListener;
    }

    public void setDismissConfirmedListener(OnDismissConfirmedListener listener) {
        mDismissConfirmedListener = listener;
    }
    ...
    private final Runnable mHideRunnable = new Runnable() {
        @Override
        public void run() {
            if(mContainer != null && mFadeOutAnimation != null) {
                mContainer.startAnimation(mFadeOutAnimation);
            }
        }
    };
